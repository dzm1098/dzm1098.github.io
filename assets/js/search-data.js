...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/website/";
          ...
          title: "CV",
          description: "Resume, education, experience, and skills.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/website/projects/0_featured_project/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/website/assets/pdf/Ziming_Dong_Resume.docx", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%7A%6D%31%30%39%38@%75%76%69%63.%63%61", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
